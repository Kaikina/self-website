...
Las interrupciones bajaron. Un PM que habría ido a ver a un dev ahora le pregunta primero al portal, y la mayoría de las veces ahí se acaba. Cuando no — cuando la pregunta es de verdad sutil, o la respuesta pide un juicio humano — el dev al que se recurre parte de una respuesta real con referencias de archivos reales, no de un «¿le puedes echar un ojo?» en frío. Y los tickets mejoraron por el camino: llegan con la forma que les da el código real, con una causa sospechada, los archivos en juego, una idea del alcance. La investigación que se hacía de palabra y luego desaparecía ahora se escribe una vez y se lleva hasta el trabajo.
